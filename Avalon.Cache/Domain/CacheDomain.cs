...
namespace Avalon.Utility
{
    ...
    public static class CacheDomain
    {
        ...
        /// 单例对象缓存域。
        /// </returns>
        public static CacheDomain<TEntity> CreateSingleton<TEntity>(Func<TEntity> missingItemHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
        ...
        /// 单键对象缓存域。
        /// </returns>
        public static CacheDomain<TEntity, TKey> CreateSingleKey<TEntity, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TKey, TEntity> missingItemHandler, Func<IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
        ...
        /// 两键对象缓存域。
        /// </returns>
        public static CacheDomain<TEntity, TParam, TKey> CreatePairKey<TEntity, TParam, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TParam, TKey, TEntity> missingItemHandler, Func<TParam, IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity, TParam, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
        ...
        public static CacheDomain<TEntity, TParam1, TParam2, TKey> CreateTripletKey<TEntity, TParam1, TParam2, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TParam1, TParam2, TKey, TEntity> missingItemHandler, Func<TParam1, TParam2, IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity, TParam1, TParam2, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
        ...
        public static CacheDomain<TEntity> Create<TEntity>(Func<TEntity> missingItemHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity>(missingItemHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
        ...
        public static CacheDomain<TEntity, TKey> Create<TEntity, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TKey, TEntity> missingItemHandler, Func<IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
        ...
        public static CacheDomain<TEntity, TParam, TKey> Create<TEntity, TParam, TKey>(Func<TEntity, TKey> entityKeySelector, Func<TParam, TKey, TEntity> missingItemHandler, Func<TParam, IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
            where TEntity : class
        {
            return new CacheDomain<TEntity, TParam, TKey>(entityKeySelector, missingItemHandler, missingItemsHandler, cacheName, cacheKeyFormat, secondesToLive);
        }
