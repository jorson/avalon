...
namespace Avalon.Utility
{
    ...
    public class CacheDomain<TEntity, TKey> : AbstractCacheDomain where TEntity : class
    {
        ...
        public CacheDomain(Func<TEntity, TKey> entityKeySelector, Func<TKey, TEntity> missingItemHandler, Func<IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
        ...
        {
            return Cache.Contains(typeof(TEntity), option.GetCacheKey(key));
        }
    }
}
