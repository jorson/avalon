...
namespace Avalon.Utility
{
    ...
    public class CacheDomain<TEntity, TParam, TKey> : AbstractCacheDomain where TEntity : class
    {
        ...
        public CacheDomain(Func<TEntity, TKey> entityKeySelector, Func<TParam, TKey, TEntity> missingItemHandler, Func<TParam, IEnumerable<TKey>, IEnumerable<TEntity>> missingItemsHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
        ...
        {
            return Cache.Contains(typeof(TEntity), option.GetCacheKey(param, key));
        }
    }
}
