...
namespace Avalon.Utility
{
    ...
    public class CacheDomain<TEntity, TParam1, TParam2, TKey> : AbstractCacheDomain where TEntity : class
    {
        ...
        {
            return Cache.Contains(typeof(TEntity), option.GetCacheKey(param1, param2, key));
        }
    }
}
