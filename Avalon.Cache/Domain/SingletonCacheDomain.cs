...
namespace Avalon.Utility
{
    ...
    public class CacheDomain<TEntity> : AbstractCacheDomain where TEntity : class
    {
        ...
        public CacheDomain(Func<TEntity> missingItemHandler, string cacheName = null, string cacheKeyFormat = null, int secondesToLive = 0)
        ...
        {
            return Cache.Contains(typeof(TEntity), option.GetCacheKey());
        }
    }
}
