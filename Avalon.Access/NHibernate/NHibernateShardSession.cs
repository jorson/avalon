...
{
    public interface INHibernateShardSession : IShardSession
    {
        ISession InnerSession { get; set; }
    }

    public class NHibernateShardSession<TEntity> : IShardSession<TEntity>, INHibernateShardSession
    {
        ISession session;

        internal NHibernateShardSession()
        {
        }
