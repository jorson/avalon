...
namespace Avalon.Framework
{
    ...
    public interface IShardedRepository<TEntity, TParam> : IRepository<TEntity> where TEntity : class
    {
        /// <summary>
        /// 创建一个规约对象
        /// </summary>
    ...
    public interface IShardedRepository<TEntity, TParam1, TParam2> : IRepository<TEntity> where TEntity : class
    {
        /// <summary>
        /// 创建一个规约对象
        /// </summary>
    ...
    public abstract class AbstractShardedRepository<TEntity, TParam> : AbstractRepository<TEntity>, IShardedRepository<TEntity, TParam> where TEntity : class
    {
    ...
    public abstract class AbstractShardedRepository<TEntity, TParam1, TParam2> : AbstractRepository<TEntity>, IShardedRepository<TEntity, TParam1, TParam2> where TEntity : class
    {
