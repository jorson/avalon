...
{
    public class ClassJoinCacheDependDefineMetadata
    {
        private ClassJoinCacheDependDefineMetadata() { }
        ...
        public static ClassJoinCacheDependDefineMetadata Create<TRegionEntity>()
        {
            return new ClassJoinCacheDependDefineMetadata()
            {
